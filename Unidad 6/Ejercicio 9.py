...
celsius = float(input("Ingrese la temperatura que desea convertir a ºF: "))
temp_fahrenheit = celsius_a_fahrenheit(celsius)

print(f"{celsius}ºC es equivalente a {temp_fahrenheit}ºF")